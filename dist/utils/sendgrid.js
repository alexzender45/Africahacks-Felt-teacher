...
exports.SuccessfulPasswordReset = SuccessfulPasswordReset;
exports.deleteAccountEmail = deleteAccountEmail;
exports.connectWithUser = connectWithUser;
exports.approveUsers = approveUsers;
...
function sendEmail(Email) {
  ...
  _mail.default.send(msg).then(result => {}).catch(error => {
    // Log friendly error
    console.error(error);
...
function passwordEmail(Name, Email, link) {
  ...
  _mail.default.send(msg).then(result => {
    console.log(result);
  }).catch(error => {
    // Log friendly error
    console.error(error);
...
function connectWithUser(sendMessage, Email) {
  const msg = {
    to: Email,
    // Change to your recipient
    from: process.env.VERIFIED_EMAIL,
...
function approveUsers(Name, Email, link) {
  const msg = {
    to: Email,
    // Change to your recipient
    from: process.env.VERIFIED_EMAIL,
...
function completeProfile(Name, Email, Account) {
  const msg = {
    to: process.env.AUTOMATED_EMAIL,
    // Change to your recipient
    from: process.env.VERIFIED_EMAIL,
    // Change to your verified sender
