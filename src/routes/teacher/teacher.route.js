...
router
  ...
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInMathematics)

  router.route('/teachers/English')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInEnglish)

  router.route('/teachers/Biology')
  .get(authenticate, permit(['admin', 'user', 'school']), approvedTeachersInBiology)

  router.route('/teachers/Commerce')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInCommerce)

  router.route('/teachers/Government')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInGovernment)

  router.route('/teachers/EnglishLiterature')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInEnglishLiterature)

  router.route('/teachers/History')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInHistory)

  router.route('/teachers/CivicEducation')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInCivicEducation)

  router.route('/teachers/IslamicReligiousStudies')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInIslamicReligiousStudies)

  router.route('/teachers/ChristianReligiousStudies')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInChristianReligiousStudies)

  router.route('/teachers/Physics')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInPhysics)

  router.route('/teachers/Geography')
  .get( authenticate, permit(['user', 'school', 'admin']),approvedTeachersInGeography)

  router.route('/teachers/Chemistry')
  .get(authenticate, permit(['user', 'school', 'admin']), approvedTeachersInChemistry)

  router.route('/teachers/Account')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInAccount)

  router.route('/teachers/Economics')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersInEconomics)

  router.route('/teachers/Primary')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersForPrimary)

  router.route('/teacher/JuniorSecondary')
  .get(authenticate, permit(['user', 'school', 'admin']),approvedTeachersForJuniorSecondary)

router
  .route('/teachers/:_id')
  .get(authenticate, permit(['user', 'school', 'admin']), fetchOne)
